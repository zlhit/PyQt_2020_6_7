                        ...
                        if len(self.msg_list) == 723:
                            try:
                                ...
                                self.current_rms_list = [(int(self.current_rms_str_list[i+7]+self.current_rms_str_list[i+6]+self.current_rms_str_list[i+5]+self.current_rms_str_list[i+4]+
                                                         self.current_rms_str_list[i+3] + self.current_rms_str_list[i+2]+self.current_rms_str_list[i+1] + self.current_rms_str_list[i],16))**0.5
                                ...
                                try:
                                    ...
                                    if self.cs2.fetchall():
                                        ...
                                        sql_create_table = "create table {}_{} (ID int auto_increment primary key,time datetime, preict_result varchar(10), welding_machine varchar(10),welding_material varchar(20)," \
                                                           ...
                                                           "D0_Dmax varchar(30),Dlast_Dmin varchar(30))".format(datetime.datetime.now().year,datetime.datetime.now().month)
                                    ...
                                    sql_ = "insert into {} values(0,'{}','{}','{}','{}','{}','1','{}','{}','{}','{}','{}',null,null,null,null,null,null,'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(str(datetime.datetime.now().year) +'_'+str(datetime.datetime.now().month),
                                        ...
                                        self.character_data[0][8], self.character_data[0][9], self.character_data[0][10],self.character_data[0][11]
                                                                                                           )
