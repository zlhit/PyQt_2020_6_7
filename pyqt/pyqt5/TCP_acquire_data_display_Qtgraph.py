...
class App(QTabWidget):
    ...
    def __init__(self,st):
        ...
        self.machine_num.setFixedWidth(76)
    ...
    def mysql_last_point(self):
        ...
        self.cs1 = self.conn.cursor()
        self.cs1.execute('use resistance')
        self.cs1.execute("select * from {}_{} order by time desc limit {},1".format(datetime.datetime.now().year,datetime.datetime.now().month,self.index))
        # self.cs1.execute('select * from 2020_7')
